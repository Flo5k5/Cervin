 ...
 */
class TypeElement extends \Collection\Entity\TypeElement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'nom', 'type', 'champs', 'elements', 'relation_origine', 'relation_destination', 'valide');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeElement $proxy) {
