 ...
 */
class Artefact extends \Collection\Entity\Artefact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'medias', 'relations_origine', 'relations_destination', 'id', 'titre', 'description', 'onLine', 'type_element', 'datas', 'relation_origine', 'relation_destination');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Artefact $proxy) {
