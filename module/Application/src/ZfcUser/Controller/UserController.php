...
class UserController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        echo $this->getEntityManager()->getRepository('SamUser\Entity\User')->findBy(array('roles'=>['Admin']));
        echo "banananananananana";
        return array(
            'admins'=>$this->getEntityManager()->getRepository('SamUser\Entity\User')->findBy(array('roles'=>['Admin']))
        );
    }
